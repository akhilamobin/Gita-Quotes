 ...
 */
class GitaQuotesBook {

    String [] gitaQuotes = { "Whenever dharma declines and the purpose of life is forgotten, I manifest myself on earth. I am born in every age to protect the good, to destroy evil, and to reestablish dharma",
    ...
    private String gitaQuote = "";

    public String getQuote(){

        Random randomGenerator = new Random();
        int randomNumber = randomGenerator.nextInt(gitaQuotes.length);

        gitaQuote = gitaQuotes[randomNumber];
